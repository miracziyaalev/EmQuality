...
List<OperationModel> operationModelFromJson(String str) =>
    List<OperationModel>.from(
        json.decode(str).map((x) => OperationModel.fromJson(x)));

String operationModelToJson(List<OperationModel> data) =>
